...
var ioncorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = ioncorenode.version;
  var create = ioncorenode.scaffold.create;
  var add = ioncorenode.scaffold.add;
  var start = ioncorenode.scaffold.start;
  var remove = ioncorenode.scaffold.remove;
  var callMethod = ioncorenode.scaffold.callMethod;
  var findConfig = ioncorenode.scaffold.findConfig;
  var defaultConfig = ioncorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with ioncore Node configuration')
    .option('-d, --daemon', 'Make ioncore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ioncore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ioncore-node add wallet-service');
      console.log('    $ ioncore-node add ion-insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ioncore-node remove wallet-service');
      console.log('    $ ioncore-node remove ion-insight-api');
      console.log();
    });
