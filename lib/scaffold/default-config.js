...
/**
 * Will return the path and default ioncore-node configuration. It will search for the
 * configuration file in the "~/.ioncore" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.ioncore');
  var defaultConfigFile = path.resolve(defaultPath, './ioncore-node.json');
