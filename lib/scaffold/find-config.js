...
/**
 * Will return the path and ioncore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'ioncore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'ioncore-node.json'))
  };
}
